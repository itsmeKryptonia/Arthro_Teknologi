<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('article.form.post')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <main class="p-6 md:px-24 font-inter min-h-[85vh] flex flex-col justify-center">
            ...
            <div class="my-4">
                ...
                <div id="modal" class="flex gap-2 text-gray-400 mb-2">
                    <img src="<?php echo e(asset('assets/img/plus-solid.svg')); ?>" alt="icon">Add
                    attachments
                </div>
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tubes-tim-b-master\resources\views/halaman/form_article.blade.php ENDPATH**/ ?>