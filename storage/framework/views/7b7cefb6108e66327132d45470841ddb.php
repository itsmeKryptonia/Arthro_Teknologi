                ...
                <div class="flex flex-col md:flex-row gap-4 border rounded-lg p-4">
                    ...
                    <div class="flex flex-col gap-6 md:gap-0 justify-between">
                        ...
                        <p class="flex items-center text-xl gap-1 font-medium"><img class="w-10"
                                src="assets/img/icon-name.png" alt="icon">Achmad
                            Rudi</p>
                    </div>
                </div>
                <div class="flex flex-col md:flex-row gap-4 border rounded-lg p-4">
                    ...
                    <div class="flex flex-col gap-6 md:gap-0 justify-between">
                        ...
                        <p class="flex items-center text-xl gap-1 font-medium"><img class="w-10"
                                src="assets/img/icon-name.png" alt="icon">Ahmad
                            Dafiqi</p>
                    </div>
                </div>
                <div class="flex flex-col md:flex-row gap-4 border rounded-lg p-4">
                    ...
                    <div class="flex flex-col gap-6 md:gap-0 justify-between">
                        ...
                        <p class="flex items-center text-xl gap-1 font-medium"><img class="w-10"
                                src="assets/img/icon-name.png" alt="icon">Daffa
                            Raihan</p>
                    </div>
                </div>
            </div>
            ...
            <?php if($article): ?>
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12">
                    <?php $__currentLoopData = $article; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('article.detail', 1)); ?>" class="border p-4 rounded-md">
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tubes-tim-b-master\resources\views/halaman/home.blade.php ENDPATH**/ ?>