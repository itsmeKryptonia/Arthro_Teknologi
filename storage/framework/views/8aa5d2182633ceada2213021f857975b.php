<header class="w-full border">
    <nav class="p-4 w-full flex justify-between md:justify-around items-center relative z-10 bg-white">
        <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('assets/img/logo1.png')); ?>" alt="" class="h-7 w-auto"></a>
        <div
            ...
            <a class="flex gap-2 items-center" href="<?php echo e(request()->is('/') ? '#home' : route('home')); ?>"><img
                    class="w-4 hidden md:block" src="<?php echo e(asset('assets/img/home-svgrepo-com.svg')); ?>" alt="icon">
                Home</a>
            <a class="flex gap-2 items-center" href="<?php echo e(request()->is('/') ? '#about' : route('home')); ?>"><img
                    class="w-4 hidden md:block" src="<?php echo e(asset('assets/img/view-list-svgrepo-com.svg')); ?>"
                    alt="icon">
                About</a>
            <a class="flex gap-2 items-center" href="<?php echo e(request()->is('/') ? '#team' : route('home')); ?>"><img
                    class="w-4 hidden md:block" src="<?php echo e(asset('assets/img/team-svgrepo-com.svg')); ?>" alt="icon">
                Team</a>
            <a class="flex gap-2 items-center" href="<?php echo e(route('article')); ?>"><img class="w-4 hidden md:block"
                    src="<?php echo e(asset('assets/img/newspaper-regular.svg')); ?>" alt="icon">
                Article</a>
        </div>
        <div class="hidden md:block">
            <?php if(session('id') !== null): ?>
                <a href="<?php echo e(route('logout')); ?>" class="bg-blue-500 text-base text-white py-2 px-5 rounded-md">Log
                    out</a>
            <?php else: ?>
                <a href="<?php echo e(route('register')); ?>"
                    class="bg-blue-500 text-base text-white py-2 px-5 rounded-md mr-2">Sign
                    Up</a>
                <a href="<?php echo e(route('login')); ?>" class="bg-blue-500 text-base text-white py-2 px-5 rounded-md">Sign
                    in</a>
            <?php endif; ?>
        </div>
    ...
    <div
        ...
        <a class="text-lg w-full text-center py-4 block hover:bg-gray-600" href="<?php echo e(route('article')); ?>">Article</a>
    </div>
</header>
<?php /**PATH C:\xampp\htdocs\tubes-tim-b-master\resources\views/component/header.blade.php ENDPATH**/ ?>