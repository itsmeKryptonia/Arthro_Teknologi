    ...
    <main class="flex flex-col shadow-lg w-96 p-6">
        ...
        <form action="<?php echo e(route('register.post')); ?>" method="POST">
            ...
            <div class="bg-gray-100 p-3 rounded-md flex justify-between mb-4">
                <img class="w-5" src="<?php echo e(asset('assets/img/envelope-regular.svg')); ?>" alt="">
                <input
            ...
            <div class="bg-gray-100 p-3 rounded-md flex justify-between mb-4">
                <img class="w-5" src="<?php echo e(asset('assets/img/user-icon.svg')); ?>" alt="">
                <input
                    class="placeholder:font-inter placeholder:text-gray-400 focus:outline-none bg-gray-100 w-full px-3"
            ...
            <div class="bg-gray-100 p-3 rounded-md flex justify-between mb-8">
                <img class="w-5" src="<?php echo e(asset('assets/img/lock-svgrepo-com.svg')); ?>" alt="eye">
                <input
                    class="placeholder:font-inter placeholder:text-gray-400 focus:outline-none bg-gray-100 w-full px-3"
                    type="password" id="password" name="password" placeholder="Enter password">
                <img id="eye" src="<?php echo e(asset('assets/img/eye-slash-regular.svg')); ?>" alt="eye">
            </div>
            <div>
...
<?php /**PATH C:\xampp\htdocs\tubes-tim-b-master\resources\views/auth/register.blade.php ENDPATH**/ ?>